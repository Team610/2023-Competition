...
public class R_CCone_1Half_Bal extends SequentialCommandGroup {
        private Trajectory preload_m, balance_m;

        public R_CCone_1Half_Bal() {
                String preloadHigh = "paths/output/RedPreloadPickup.wpilib.json";
                Path preload = Filesystem.getDeployDirectory().toPath().resolve(preloadHigh);
                String balance = "paths/output/RedPickupBal.wpilib.json";
