...
public class G_PreloadCoopLeft extends SequentialCommandGroup {
         ...
         * occurence
         */
        public G_PreloadCoopLeft() {
                String preloadHigh = "paths/output/CoopPreloadLeft.wpilib.json";
                Path preload = Filesystem.getDeployDirectory().toPath().resolve(preloadHigh);
                String pickupHigh = "paths/output/RightPickupRight.wpilib.json";
                ...
                addCommands(
                        ...
                        Commands.sequence(new A_Reset_Odometry(pickup_m), RamseteSetup.initializeRamseteCommand(pickup_m))
                );
        }
}
