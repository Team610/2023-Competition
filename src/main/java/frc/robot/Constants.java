...
public final class Constants {
    ...
    public static class TronWheel {
        ...
        public static final double VAL_ANGLE_GROUND_INIT = 28000;  // angle to pickup from ground start
        public static final double VAL_ANGLE_GROUND_FINAL = VAL_ANGLE_GROUND_INIT+2000;  // angle to pickup from ground finish
